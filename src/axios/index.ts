...
export type Config = InternalAxiosRequestConfig & RequestInit
 ...
 */
async function getResponse(request: Request, config: Config): Promise<MixResponse> {
 ...
 */
function createError(message: string, config: Config, code: string, request: Request, response?: any) {
